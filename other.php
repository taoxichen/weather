                ...
                <form class="am-form am-margin-bottom-lg" method="post" id="form-vld">
                    <div class="am-u-md-12 am-u-sm-centered">
                        <ul id="form-tabs" class="am-nav am-nav-pills am-nav-justify am-margin-bottom music-tabs">
                            ...
                            <li class="am-active" data-filter="url">
                                <a href="/other.php">其他</a>
                            </li>
                        </ul>
                        <div class="am-form-group">
                         	<a href=""><button class="btn-6">星座</button></a>
	                        <a href=""><button class="btn-2">黄历</button></a>
	                        <a href=""><button class="btn-3">等待开发</button></a>
	                        <a href=""><button class="btn-7">等待开发</button></a>
